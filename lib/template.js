...
<button type="button" class="btn_pay btn_pay_hover" id="web" onclick="window.location.href='/kakaopay_process_web'">
PC 결제
</button>
<button type="button" class="btn_pay btn_pay_hover" id="mobile" onclick="window.location.href='/kakaopay_process_mobile'">
모바일 결제
</button>
<!--
...
<script type='text/javascript'>
  ...
  //]]>
    ...
    <html>
    <head>
      <title>WEB1 - kakaopay</title>
      <meta charset="utf-8">
    </head>
    <body>
    <a href="/kakaopay_process">
    <img src="lib/image1.png" alt="kakaopay_image" >
    </a>
    </body>
    </html>
    `
